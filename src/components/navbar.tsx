...
export default function Navbar({ children }: NavbarProps) {
    return (
        <nav className="bg-white px-2 sm:px-4 dark:bg-gray-900 sticky w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
            <div className="container flex flex-wrap justify-between items-center mx-auto">
                <a href="https://flowbite.com/" className="flex items-center">
                    <Image width={30} height={30} src="/favicon.ico" className="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
